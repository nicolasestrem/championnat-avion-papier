...
12. **Date de l'événement** : `reglages.json` affiche le 13 juin 2026, or nous sommes le 14 juillet 2026 — l'événement est passé. Si le site bascule maintenant, faut-il mettre à jour la date/le contenu vers l'édition suivante, ou assumer la page « édition 2026 » jusqu'à l'annonce 2027 ? *Partiellement traité le 14/07/2026 : la page rétrospective `/editions/2026/` existe désormais (galerie de 7 photos du 13 juin) — mais l'accueil/le hero annoncent toujours l'événement comme à venir ; la décision reste à prendre.*
